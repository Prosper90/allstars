...
export default function Nav({setSelected, selected}) {
  return (
<>
    ...
    <ul className="flex gap-2 flex-col  pl-0 mb-0">
      ...
      <li className="mt-0.5 w-full">
        <div
          ...
          onClick={() => setSelected("addproject")}
        >
    ...
    >
      ...
      <div className="relative z-20 flex-auto w-full p-4 text-left text-white">
        ...
        <div className="transition-all duration-200 ease-nav-brand">
          ...
          <a
            href="//www.creative-tim.com/learning-lab/tailwind/html/quick-start/soft-ui-dashboard/"
            target="_blank"
