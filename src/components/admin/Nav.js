...
export default function Nav({setSelected, selected, setNavbar}) {


  const takeSelected = (choice) => {
    setSelected(choice)
    setNavbar(false)
  }
...
<>
  ...
  <div className="items-center block w-auto max-h-screen overflow-auto h-sidenav grow basis-full">
    <ul className="flex gap-2 flex-col  pl-0 mb-0">

      <li className="mt-2 w-full">
        <div
          className={`${selected === "home" ? "py-2.7 shadow-soft-xl text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap rounded-lg bg-white px-4 font-semibold text-slate-700 transition-colors" : "py-2.7 text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 transition-colors" }`}
          onClick={() => takeSelected("home")}
        >
          <div className={` ${selected === "home" && "bg-gradient-to-tl from-purple-700 to-pink-500" }  shadow-soft-2xl mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-white bg-center stroke-0 text-center xl:p-2.5`}>
            <svg
              width="12px"
              height="12px"
              viewBox="0 0 45 40"
                ...
                >
                  <g transform="translate(1716.000000, 291.000000)">
                    <g transform="translate(0.000000, 148.000000)">
                      <path
                        className={`${selected !== "home" && "fill-slate-800"} opacity-60`}
                      ...
                      />
                      <path
                        className={`${selected !== "home" && "fill-slate-800"} `}
      ...
      <li className="mt-0.5 w-full">
        <div
          className={`${selected === "projects" ? "py-2.7 shadow-soft-xl text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap rounded-lg bg-white px-4 font-semibold text-slate-700 transition-colors" : "py-2.7 text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 transition-colors" }`}
          onClick={() => takeSelected("projects")}
        >
          <div className={`${selected === "projects" && "bg-gradient-to-tl from-purple-700 to-pink-500" }  shadow-soft-2xl mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-white bg-center stroke-0 text-center xl:p-2.5`}>
            <svg
              width="12px"
              height="12px"
              viewBox="0 0 42 42"
                ...
                >
                  <g transform="translate(1716.000000, 291.000000)">
                    <g transform="translate(153.000000, 2.000000)">
                      <path
                        className={`${selected !== "projects" && "fill-slate-800"} opacity-60`}
                        d="M12.25,17.5 L8.75,17.5 L8.75,1.75 C8.75,0.78225 9.53225,0 10.5,0 L31.5,0 C32.46775,0 33.25,0.78225 33.25,1.75 L33.25,12.25 L29.75,12.25 L29.75,3.5 L12.25,3.5 L12.25,17.5 Z"
                      />
                      <path
                        className={`${selected !== "projects" && "fill-slate-800"} `}
      ...
      <li className="mt-0.5 w-full">
        <div
          className={`${selected === "addproject" ? "py-2.7 shadow-soft-xl text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap rounded-lg bg-white px-4 font-semibold text-slate-700 transition-colors" : "py-2.7 text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 transition-colors" }`}
          onClick={() => takeSelected("addproject")}
        >
          <div className={`${selected === "addproject" && "bg-gradient-to-tl from-purple-700 to-pink-500" }  shadow-soft-2xl mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-white bg-center stroke-0 text-center xl:p-2.5`}>
            <svg
              width="12px"
              height="12px"
              viewBox="0 0 43 36"
                ...
                >
                  <g transform="translate(1716.000000, 291.000000)">
                    <g transform="translate(453.000000, 454.000000)">
                      <path
                        className={`${selected !== "addproject" && "fill-slate-800"} opacity-60`}
                        d="M43,10.7482083 L43,3.58333333 C43,1.60354167 41.3964583,0 39.4166667,0 L3.58333333,0 C1.60354167,0 0,1.60354167 0,3.58333333 L0,10.7482083 L43,10.7482083 Z"
                      />
                      <path
                        className={`${selected !== "addproject" && "fill-slate-800"} `}
    ...
    >
      ...
      <div className="relative z-20 flex-auto w-full p-4 text-left text-white">
        ...
        <div className="transition-all duration-200 ease-nav-brand">
          <h6 className="mb-0 text-white">Admin base</h6>
          <p className="mt-0 mb-4 font-semibold leading-tight text-xs">
            Add, Edit and Approve projects
          </p>
          <a
            href="/"
            target="_blank"
